    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApplicationLanguage", x => new { x.ApplicationsId, x.LanguagesId });
                    table.ForeignKey(
                        name: "FK_ApplicationLanguage_Applications_ApplicationsId",
                        column: x => x.ApplicationsId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ApplicationLanguage_Languages_LanguagesId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Translations_Applications_ApplicationId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ApplicationId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    Sluggish = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Articles_Applications_ApplicationId",
                        column: x => x.ApplicationId,
                        principalTable: "Applications",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArticleVersions_Languages_LanguageId",
                        column: x => x.LanguageId,
                        principalTable: "Languages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArticleVersions_Users_CreatedById",
                        column: x => x.CreatedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArticleVersions_Users_DeletedById",
                        column: x => x.DeletedById,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ArticleVersions_Users_UpdatedById",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ApplicationLanguage_LanguagesId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Articles_ActiveVersionId",
                table: "Articles",
                column: "ActiveVersionId");

            migrationBuilder.CreateIndex(
                name: "IX_Articles_ApplicationId",
                table: "Articles",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleVersions_CreatedById",
                table: "ArticleVersions",
                column: "CreatedById");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleVersions_DeletedById",
                table: "ArticleVersions",
                column: "DeletedById");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleVersions_LanguageId",
                table: "ArticleVersions",
                column: "LanguageId");

            migrationBuilder.CreateIndex(
                name: "IX_ArticleVersions_UpdatedById",
                table: "ArticleVersions",
                column: "UpdatedById");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Translations_ApplicationId",
                table: "Translations",
                column: "ApplicationId");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_Articles_ArticleVersions_ActiveVersionId",
                table: "Articles",
                column: "ActiveVersionId",
